...
/***/ function(module, exports, __webpack_require__) {
	...
	var _IndexPage = __webpack_require__(222);

	var _IndexPage2 = _interopRequireDefault(_IndexPage);

	var _BallerViews = __webpack_require__(224);

	var _BallerViews2 = _interopRequireDefault(_BallerViews);

	var _Baller = __webpack_require__(271);

	var _Baller2 = _interopRequireDefault(_Baller);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MasterPage = _react2.default.createClass({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _IndexPage = __webpack_require__(223);
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'h1',
	          { className: 'title-logo eleven columns' },
	          'Ullibol'
	        ),
	        _react2.default.createElement(
	          'p',
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'card-panel z-depth-1', style: _IndexPage.loginCard },
	            _react2.default.createElement('img', { className: 'IndexPageMexicoLogo', src: 'http://bit.ly/1Oo4wPS' }),
	            _react2.default.createElement(
	              'p',
	              { className: 'IndexPageCardParagraph' },
	              'This is a data visualization app dedicated to the ',
	              _react2.default.createElement('br', null),
	              'players of The Mexican Nation Football Team that ',
	              _react2.default.createElement('br', null),
	              'will be attending the Copa America Centenario ',
	              _react2.default.createElement('br', null),
	              'USA 2016. ©2016 Freddie Cabrera.'
	            ),
	            _react2.default.createElement('div', { className: 'IndexPageVerticalLine' }),
	            _react2.default.createElement(
	              'div',
	              { style: _IndexPage.IndexPageInputFields },
	              _react2.default.createElement(
	                'h5',
	                { className: 'IndexPageLoginText' },
	                'Login'
	              ),
	              _react2.default.createElement(
	                'div',
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                      'button',
	                      { style: _IndexPage.IndexPageLoginButton, className: 'btn waves-effect waves-light col s5', type: 'submit', value: 'Login' },
	                      'Login'
	                    )
	                  )
	                ),
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    'div',
	                    { className: 'col s12', style: { marginTop: '-1em' } },
	                    _react2.default.createElement(
	                      _reactRouter.Link,
	                      { to: 'forgot' },
	                      _react2.default.createElement(
	                        'span',
	                        { style: _IndexPage.IndexPageForgotPassword },
	                    ...
	                    _react2.default.createElement(
	                      ...
	                      _react2.default.createElement(
	                        'span',
	                        { style: _IndexPage.IndexPageSignup },
	                        'Sign Up'
	                      )
	                    )
	                  )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BallerViews = __webpack_require__(229);
	...
	var _GridView = __webpack_require__(269);

	var _GridView2 = _interopRequireDefault(_GridView);

	var _ListView = __webpack_require__(270);

	var _ListView2 = _interopRequireDefault(_ListView);

	var _Loader = __webpack_require__(272);
	...
	var BallerViews = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return this.props.fetching ? _react2.default.createElement(_Loader2.default, null) : _react2.default.createElement(
	      'div',
	      null,
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'col s12', style: { marginLeft: '10%' } },
	            _react2.default.createElement(
	              'h5',
	              { className: 'col s7', style: _BallerViews.MexNatFootTeam },
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, actions)(BallerViews);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Menu = __webpack_require__(226);

	var _Menu2 = _interopRequireDefault(_Menu);

	var _MenuButton = __webpack_require__(228);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isHostObject = __webpack_require__(240),
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(243)(global || window || undefined);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ALL_FOOTBALLERS_ULLIBOL_URL = 'http://ullibolserver.herokuapp.com/allfootballers/allfootballers';
	var PLAYER_DATA_ULLIBOL_URL = 'http://ullibolserver.herokuapp.com/footballers/';
	...
	var UllibolPlayersCall = function UllibolPlayersCall(dispatch) {
	  _axios2.default.get(ALL_FOOTBALLERS_ULLIBOL_URL).then(function (response) {
	...
	function getPlayers() {
	  return function (dispatch) {
	    dispatch({ type: _types.FETCHING_PLAYER, fetching: true });
	...
	var UllibolPlayerDataCall = function UllibolPlayerDataCall(dispatch, url) {
	  ...
	  _axios2.default.get(url).then(function (response) {
	    var data = response.data;
	    dispatch({ type: _types.FETCHING_PLAYER, fetching: false });
	    return dispatch({ type: _types.GET_PLAYER_DATA, playerData: data });
	  }).catch(function (error) {
	    return dispatch({ type: _types.GET_PLAYERS_ERROR, error: error });
	  });
	};
	...
	function getPlayerData(player) {
	  var url = 'http://demo7284574.mockable.io/getplayer';
	  return function (dispatch) {
	    dispatch({ type: _types.FETCHING_PLAYER, fetching: true });
...
/***/ function(module, exports) {
	...
	var GET_PLAYER_DATA = exports.GET_PLAYER_DATA = 'GET_PLAYER_DATA';
	var FETCHING_PLAYER = exports.FETCHING_PLAYER = 'FETCHING_PLAYER';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Baller = _react2.default.createClass({
	  displayName: 'Baller',
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      'div',
	      null,
	      fetching ? _react2.default.createElement(_Loader2.default, null) : _react2.default.createElement(
	        'h1',
	        null,
	        'Hello'
	      )
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, actions)(Baller);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UserInteractionsReducer = __webpack_require__(276);

	var _UserInteractionsReducer2 = _interopRequireDefault(_UserInteractionsReducer);

	var _PlayersReducer = __webpack_require__(277);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PlayersReducer = function PlayersReducer() {
	  ...
	  switch (action.type) {
	    ...
	    case _types.GET_PLAYER_DATA:
	      return _extends({}, state, { playerData: action.playerData });
	    case _types.FETCHING_PLAYER:
